...
export default function ConfirmPageClient({
  ...
  return <ConfirmPageInner token={token} vendorName={vendorName} businessName={businessName} items={items} deliveryDate={deliveryDate} />
}

function ConfirmPageInner({ token, vendorName, businessName, items, deliveryDate }: { token: string; vendorName: string; businessName: string; items: Item[]; deliveryDate: string }) {
      ...
      <div className="min-h-screen bg-[#0F1B2D] flex items-center justify-center p-6">
        <div className="text-center max-w-sm fade-in">
          ...
          <p className="text-sm text-[#64748B] leading-relaxed mb-6">
            Thank you. <span className="text-[#F7F5F0] font-medium">{businessName}</span> has been notified and the event has been logged.
          </p>
      ...
      <div className="min-h-screen bg-[#0F1B2D] flex items-center justify-center p-6">
        <div className="text-center max-w-sm fade-in">
          ...
          <p className="text-sm text-[#64748B] leading-relaxed mb-4">
            You&apos;ve declined this order. <span className="text-[#F7F5F0] font-medium">{businessName}</span> has been notified.
          </p>
          {declineReason && (
      ...
      <div className="w-full max-w-md fade-in">
        ...
        <div className="bg-[#162236] border border-[#1E3050] rounded-2xl overflow-hidden shadow-xl">
          ...
          <div className="px-6 py-5 border-b border-[#1E3050] bg-[#0D1825]">
            ...
            <div>
              <h1 className="text-lg font-semibold text-[#F7F5F0]">{businessName}</h1>
              <p className="text-sm text-[#64748B] mt-0.5">To: <span className="text-[#94A3B8]">{vendorName}</span></p>
              </div>
